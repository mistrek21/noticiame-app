...
function PostManager() {
    ...
    const [post] = useDocumentData(postRef) // listen to the post in real time u can use also useDocumentDataOnce() to fetch the data only when the comp is 1st initialized
